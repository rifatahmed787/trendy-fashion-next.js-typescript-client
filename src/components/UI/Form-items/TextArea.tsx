...
const TextArea = ({
  ...
  return (
    <div className="flex flex-col gap-2 relative">
      ...
      <textarea
        id="text-box"
        className={cn("block py-3 px-0 w-full text-lg bg-transparent font-primary border-2 border-primary-100 appearance-none rounded-md focus:outline-none focus:ring-0 focus:border-primary-100 peer focus:border-t-1 pl-2",className)}
        value={currentValue}
        onChange={onChange}
