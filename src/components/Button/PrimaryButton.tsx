...
const BrandButton = ({ text, icon }: BrandButton) => {
  return (
    <>
      <button
        type="button"
        className="relative inline-flex items-center justify-center px-2 py-2 md:py-3 md:px-3  overflow-hidden font-primary font-bold text-normal border bg-primary rounded-md group"
      >
