...
//   // Debugging to check when deleteHandler changes

//     console.log("deleteHandler updated:", deleteHandler);
...
//           </Button>
//           <Button
//             onClick={deleteHandler} // Wrap in an anonymous function to avoid immediate execution
