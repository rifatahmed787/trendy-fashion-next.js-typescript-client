    ...
    <div className="my-10 px-5 md:px-10">
      <div className="my-5 grid grid-cols-1 gap-0 md:grid-cols-8 md:gap-5 lg:gap-5 items-center">
        ...
        <div className="col-span-5 ">
          <h1 className=" ml-5 text-xl font-bold relative after:absolute after:content-normal after:bg-primary-100 after:left-0 after:bottom-0 after:w-44 after:h-0.5 mb-5">
            Latest Collections
          </h1>
          {/* <hr /> */}
          <Swiper
