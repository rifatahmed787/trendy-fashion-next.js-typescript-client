  ...
  return (
    <footer className=" z-30">
      <div className="max-w-screen-2xl mx-auto  ">
        {/* Top area: Blocks */}
        <div className="bg-white relative after:content-normal after:absolute after:w-11/12 after:h-1 after:top-0  after:bg-primary-100 px-4 sm:px-6   rounded-tl-[200px] md:rounded-tl-[300px]">
